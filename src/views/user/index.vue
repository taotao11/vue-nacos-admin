<template>
  <div>
    ...
    <el-dialog title="新增" :visible.sync="selDialogIsDisable">
      <user-add :isDisable="isDisable" :form="formSel" @childFn="parentFn" />
    </el-dialog>
    <!-- 新增 -->
    <el-dialog title="新增" :visible.sync="updDialogIsDisable">
      <user-add :isDisable="isDisable" :form="formUpd" @childFn="parentFn" />
    </el-dialog>
  </div>
</template>

<script>
import { getUserList,add } from "@/api/user";
import Add from "./add";
